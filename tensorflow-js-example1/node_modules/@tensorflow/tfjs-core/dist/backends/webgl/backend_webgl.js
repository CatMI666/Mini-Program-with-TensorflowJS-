...
var MathBackendWebGL = /** @class */ (function () {
    ...
    MathBackendWebGL.prototype.fusedDepthwiseConv2D = function (_a) {
        ...
        if (shouldPackDepthwiseConv) {
            ...
            return this.compileAndRun(program, inputs, this.makePackedTensor(convInfo.outShape, input.dtype));
        }
    ...
    MathBackendWebGL.prototype.packedReshape = function (input, afterShape) {
        ...
        return this
            .compileAndRun(program, [inputAs3D], null, null, preventEagerUnpackingOfOutput)
            .reshape(afterShape);
    };
